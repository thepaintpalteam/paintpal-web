...
const plans = [
  {
    ...
    features: [
      { text: "Join 2 public painting events per month", available: true },
      { text: "Host 1 free painting event per month", available: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Host unlimited painting events", available: true },
      {
  ...
  },
  {
    ...
    features: [
      { text: "Bulk event scheduling", available: true },
      {
