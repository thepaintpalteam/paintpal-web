...
const plans = [
  {
    ...
    features: ["Join 2 public painting events", "Host 1 painting event", "No access to hosting private events", "Cancel anytime"],
  ...
  },
  {
    ...
    features: ["Join unlimited public painting events", "Host unlimited painting event", "Unilited access to hosting private events", "Integrated payment processing"],
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-24 mx-4">
      <div className="bg-white w-full max-w-xl rounded-xl shadow-lg">
        {/* Logo */}
        <div className="bg-gradient-to-b from-[#FEAF1E] to-[#FEAF1E] p-10 rounded-t-xl shadow-md flex items-center justify-center">
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <p className="flex items-end gap-1">
                ...
                <span className="text-gray-500 text-xl">{plan.price.unit}</span>
              </p>
           ...
           <button
            onClick={() => {navigate('/payment'); scrollTo(0,0)}}
              type="submit"
